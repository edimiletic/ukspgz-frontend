...
export class ModalExpenseReportDetailsComponent {
  ...
  private travelExpenses: { [key: string]: { [key: string]: number } } = {
    ...
    'Čakovo': { 'Zagreb': 105, 'V.Gorica': 105, 'Samobor': 105, 'Zabok': 130, 'Zadar': 75, 'Šibenik': 390, 'Sinj': 440, 'Split': 510, 'Omiš': 510, 'K.Sućurac': 540, 'Makarska': 490, 'Dubrovnik': 556, 'Pula': 700, 'Crikvenica': 370, 'Kostrena': 266, 'Rijeka': 257, 'Osijek': 265, 'Sl.Brod': 358, 'Đakovo': 266, 'Požega': 230, 'Čakovo': 252 },
  ...
  onLocationChange() {
    ...
    if (expense) {
      ...
      // Set quantity and unit price for display purposes
      this.expenseData.quantity = 0; // Not applicable for location-based
      this.expenseData.unitPrice = 0; // Not applicable
